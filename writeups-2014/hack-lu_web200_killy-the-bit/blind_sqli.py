...
# isp0 - 22/10/2014
#
# simple blind SQL injection tool
#
# used in Killy The Bit (hack.lu CTF 2014)
#
# ---------------------------------------------------------------------------------------
import socket
import time
...
method     = 'GET'
path       = '/index.php'
false_pat  = 'We couldn\'t find your username!' 				# the response when statement is FALSE
true_pat   = 'A new password was generated and sent to your email address!'	# the response when statement is TRUE
# ---------------------------------------------------------------------------------------
