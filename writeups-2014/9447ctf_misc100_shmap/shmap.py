# ---------------------------------------------------------------------------------------
# Contest  : 9447 Security Society CTF 2014
# Date     : 29-30/11/2014 (36hr)
# Member   : ispo@penthackon
# Challenge: shmap (Misc 100)
# Description:  shmap.9447.plumbing:9447 
# 
# (NOTE: for a better view set tab width to 8)
# ---------------------------------------------------------------------------------------
'''
