# ---------------------------------------------------------------------------------------
# Contest  : MMA 1st CTF 2015
# Date     : 05/09 - 07/09/2015 (48hr)
# Member   : ispo@b01llers
# Challenge: Login as admin (Web 30)
# Description: Login as admin. And get the flag! The flag is the password of admin.
